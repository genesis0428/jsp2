...
<!-- 				<li>글 비밀번호</li>댓글 삭제 : 1)로그인한 사용자가 본인글 삭제 또는 2)글 비밀번호 사용				
	...
	<div id="myModal" class="modal">
		...
		<div class="modal-content">
			...
			<div style="padding: 0px 20px;">
				<b>글비밀번호</b><br>
				<br>
				<form action="" method="post" name="frmPassword">		<!-- forms[1] -->
					...
					<!-- 확인 버튼 동작 : 1) 수정, 삭제에 따라 action을 변경 2) submit -->
					<br>
	...
	function modalSet(vfunc) {
		...
		document.forms[1].func.value=vfunc;		//삭제 : 1, 수정 :2 로 기능설정하기	forms[1]인 이유는 이 소스에 form이 2개이기 떄문. 첫번쨰는 댓글 삭제. 두번째는 메인글 삭제	
	}
	//메인글 수정
	function modalOK() {
