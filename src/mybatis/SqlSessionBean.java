package mybatis;		//쉽게 말하면 앞에서 했던 Connection 객체 만드는 것과 같은 과정이에요
...
// SqlSessionBean.java
//ㄴ 데이터베이스에 연결하고 sql 실행을 하기 위한 SqlSessionFactory 객체를 만든다.
//ㄴ mybatis/mybatis-config.xml 설정 내용에 따라 SqlSessionFactory 객체를 생성한다.
//ㄴ db.propertis 파일에는 아까 url,driver, username,password 4개 값 저장되어 있습니다.